...
### Editing an existing person: `edit`
Edits a person already existing in the addressbook<br>
...
Sorts all the persons in address book by alphabetical order and return the sorted list.<br>
Format: `sort`
